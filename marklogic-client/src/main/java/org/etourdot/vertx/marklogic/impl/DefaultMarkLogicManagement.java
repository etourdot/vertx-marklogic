...
public class DefaultMarkLogicManagement implements MarkLogicManagement {
  private final MarklogicRestService restService;

  private final MarkLogicManagementImpl markLogicManagement;
  private final MarkLogicAdminImpl markLogicAdmin;

  public DefaultMarkLogicManagement(Vertx vertx, MarkLogicConfig config) {
    this.restService = new DefaultRestService.Builder(vertx).marklogicConfig(config).build();

    this.markLogicManagement = new MarkLogicManagementImpl(restService);
    this.markLogicAdmin = new MarkLogicAdminImpl(restService);
  }
