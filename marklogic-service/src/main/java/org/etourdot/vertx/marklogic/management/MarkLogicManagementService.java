...
@VertxGen
@ProxyGen
public interface MarkLogicManagementService extends MarkLogicManagement {

  static MarkLogicManagementService createEventBusProxy(Vertx vertx, String address) {
    return ProxyHelper.createProxy(MarkLogicManagementService.class, vertx, address);
  }
